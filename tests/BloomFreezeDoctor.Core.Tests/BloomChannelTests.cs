...
public class BloomChannelTests
{
    ...
    public void A_developer_build_is_recognised_from_its_exe_not_only_its_dll()
    {
        ...
        var exe = BloomChannel.DeriveFromExePath(@"C:\github\BloomDesktop\output\Debug\x64\Bloom.exe");
        var dll = BloomChannel.DeriveFromExePath(@"C:\github\BloomDesktop\output\Debug\x64\Bloom.dll");
